...
public class SecurityConfig {
    ...
    public CorsConfigurationSource configurationSource() {
        ...
        configuration.addAllowedOrigin("http://123.141.189.142:3000"); // 모든 IP 주소 허용 (프론트 앤드 IP만 허용 react)
        configuration.addAllowedOrigin("http://playhive.com:3000"); // 모든 IP 주소 허용 (프론트 앤드 IP만 허용 react)
